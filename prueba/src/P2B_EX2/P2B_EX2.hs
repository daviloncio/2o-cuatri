...
main5 :: IO()
main5 = do
        putStrLn ("Tablero Original:")
        showcells glider
        putStrLn ("Ejecución usando life (3 turnos):")
        life glider 5
        putStrLn ("Ejecuciónde turnos con bool = True (3 turnos): ")
        turns glider 3 True
        putStrLn ("Ejecuciónde turnos con bool = False (3 turnos): ")
        turns glider 3 False
