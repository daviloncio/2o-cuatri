...
if __name__ == '__main__':
    ...
    for grafo in bosque_final:
        print(bosque_final[grafo]) # Reproducido con el grafo ejemplo"""

    Erdos_renyi(H,(0.9))
    Erdos_renyi(I,(1))
    Erdos_renyi(J,(1.5))
    bosqueh=(Tarjan(H))
    for grafo in bosqueh:
        print(bosqueh[grafo])
    bosquei=(Tarjan(I))
    for grafo in bosquei:
        print(bosquei[grafo],"b")
    bosquej=(Tarjan(J))
    for grafo in bosquej:
        print(bosquej[grafo],"c")
